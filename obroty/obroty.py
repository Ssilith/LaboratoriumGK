...
def render(time):
    ...
    if mode == 0:
        ...
        x_eye = R * math.cos(math.fmod(theta*(math.pi)/180, 2*(math.pi))) * math.cos(math.fmod(phi*(math.pi)/180, 2*(math.pi)))
        y_eye = R * math.sin(math.fmod(phi*(math.pi)/180, 2*(math.pi)))
        z_eye = R * math.sin(math.fmod(theta*(math.pi)/180, 2*(math.pi))) * math.cos(math.fmod(phi*(math.pi)/180, 2*(math.pi)))
